...
exports.linkPail = function(pail_id, linkpath) {

   var pailPath = internals.defaults.mainPath + '/' + internals.defaults.pailPath + '/' + pail_id;
   Fs.symlinkSync(pailPath, linkpath);
}

exports.getPailByLinkPath = function(linkpath) {

   var pailPath = Fs.readlinkSync(linkpath);
   var pail = pailPath.split('/');
   var pail_id = pail[pail.length-1];
   return pail_id;
}

exports.unlinkPail = function(linkpath) {
