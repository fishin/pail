...
exports.deleteDir = function(dir) {
    ...
    var deleteDir = this.settings.dirPath + '/' + dir;
    internals.rmrf(deleteDir);
};

exports.getArtifact = function(dir, artifact) {

    var artifactFile = this.settings.dirPath + '/' + dir + '/' + artifact;
    var contents = null;
...
exports.copyArtifact = function (sourceDir, targetDir, artifact) {
  ...
  var artifactFile = this.settings.dirPath + '/' + sourceDir + '/' + artifact;
  var archiveFile = this.settings.dirPath + '/' + targetDir + '/' + artifact;
  var contents = this.getArtifact(sourceDir, artifact);
  if (Fs.existsSync(this.settings.dirPath + '/' + targetDir)) {
...
exports.createDir = function(dir) {
    ...
    var createDir = this.settings.dirPath + '/' + dir;
...
exports.getFiles = function (dir) {
    ...
    var dirPath = this.settings.dirPath + '/' + dir;
    var list = [];
    if (Fs.existsSync(dirPath)) {
        list = Fs.readdirSync(dirPath);
    }
...
exports.createPail = function (config) {
   ...
   if (config.name) {
       if (Fs.existsSync(this.settings.dirPath + '/' + config.name)) {
...
exports.getPailByName = function(name) {
   ...
   var linkPath = this.settings.dirPath + '/' + name;
   var dirPath = null;
   try {
